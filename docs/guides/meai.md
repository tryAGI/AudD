...
The AudD SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.
...
using var client = new AudDClient(
    apiKey: Environment.GetEnvironmentVariable("AUDD_API_KEY")!);
