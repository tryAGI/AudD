...
internal static class CliRuntime
{
    ...
    public static async Task<global::AudD.AudDClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::AudD.ApiException exception)
    {
        var builder = new StringBuilder();
