...
{
    private const string UserSecretsId = "AudD.CLI";
    private const string UserSecretApiKeyName = "AUDD_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"AUDD_API_KEY"];
    private const string CredentialFileDirectoryName = ".aud-d";

    public static async global::System.Threading.Tasks.Task<global::AudD.AudDClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::AudD.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::AudD.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::AudD.AudDClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::AudD.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::AudD.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::AudD.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::AudD.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("AUDD_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::AudD.ApiException exception)
    {
        var builder = new StringBuilder();
