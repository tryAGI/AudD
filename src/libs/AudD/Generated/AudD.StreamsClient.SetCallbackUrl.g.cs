...
namespace AudD
{
    public partial class StreamsClient
    {
        ...
        {
            var __response = await SetCallbackUrlAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AudD.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AudD.AutoSDKHttpResponse<global::AudD.NullResultResponse>> SetCallbackUrlAsResponseAsync(
