...
namespace AudD
{
    public partial class StreamsClient
    {
        ...
        private static readonly global::AudD.EndPointSecurityRequirement s_GetCallbackUrlSecurityRequirement0 =
        ...
        private static readonly global::AudD.EndPointSecurityRequirement[] s_GetCallbackUrlSecurityRequirements =
            new global::AudD.EndPointSecurityRequirement[]
            {                s_GetCallbackUrlSecurityRequirement0,
            };
        partial void PrepareGetCallbackUrlArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetCallbackUrlRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetCallbackUrlResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCallbackUrlResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AudD.GetCallbackUrlResponse> GetCallbackUrlAsync(
            global::AudD.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetCallbackUrlAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AudD.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AudD.AutoSDKHttpResponse<global::AudD.GetCallbackUrlResponse>> GetCallbackUrlAsResponseAsync(
            global::AudD.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCallbackUrlArguments(
                httpClient: HttpClient);


            var __authorizations = global::AudD.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetCallbackUrlSecurityRequirements,
                operationName: "GetCallbackUrlAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AudD.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AudD.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetCallbackUrlAsync",
                                pathTemplate: "\"/getCallbackUrl/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AudD.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCallbackUrlResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AudD.GetCallbackUrlResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AudD.AutoSDKHttpResponse<global::AudD.GetCallbackUrlResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AudD.GetCallbackUrlResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
