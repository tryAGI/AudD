...
namespace AudD
{
    public partial class StreamsClient
    {
        ...
        private static readonly global::AudD.EndPointSecurityRequirement s_LongPollSecurityRequirement0 =
        ...
        private static readonly global::AudD.EndPointSecurityRequirement[] s_LongPollSecurityRequirements =
            new global::AudD.EndPointSecurityRequirement[]
            {                s_LongPollSecurityRequirement0,
            };
        partial void PrepareLongPollArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string category,
            ref int? timeout,
            ref long? sinceTime);
        partial void PrepareLongPollRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string category,
            int? timeout,
            long? sinceTime);
        partial void ProcessLongPollResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLongPollResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AudD.LongPollResponse> LongPollAsync(
            string category,
            int? timeout = default,
        ...
        {
            var __response = await LongPollAsResponseAsync(
                category: category,
                timeout: timeout,
                sinceTime: sinceTime,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AudD.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AudD.AutoSDKHttpResponse<global::AudD.LongPollResponse>> LongPollAsResponseAsync(
            string category,
            int? timeout = default,
            long? sinceTime = default,
            global::AudD.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareLongPollArguments(
                httpClient: HttpClient,
                category: ref category,
                timeout: ref timeout,
                sinceTime: ref sinceTime);


            var __authorizations = global::AudD.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_LongPollSecurityRequirements,
                operationName: "LongPollAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("category", category)
                                .AddOptionalParameter("timeout", timeout?.ToString())
                                .AddOptionalParameter("since_time", sinceTime?.ToString())
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AudD.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AudD.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "LongPollAsync",
                                pathTemplate: "\"/longpoll/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AudD.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLongPollResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AudD.LongPollResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AudD.AutoSDKHttpResponse<global::AudD.LongPollResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AudD.LongPollResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
